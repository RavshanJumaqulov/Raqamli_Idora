...
export default function MosquesByRegions() {
  const {
    data: { start_date, finish_date },
  } = useContext(StatsContext)
  const { data } = getQuery<any>(
    'common/statistics/mosque/region',
  ...
  const series = filteredData.map((item: any) => item?.[1])
  return (
    <StyledBox>
      <div className="body">
        <h2 className="title">Masjidlar viloyatlar kesimida</h2>
      ...
      <div className="foot">
        ...
        <div className="child right">
          <p className="label">Umumiy masjidlar</p>
