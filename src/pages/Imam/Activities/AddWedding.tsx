...
import { WeddingDetailInterface } from '@src/types/detailHeaderTypes'
...
export const AddWedding = () => {
    ...
    const { data: detailData, isLoading, isSuccess } = useQuery<WeddingDetailInterface>({
    ...
    const { mutate, isPending } = postMutation<IFormInput>('wedding/create', {
        onSuccess: (data) => {
