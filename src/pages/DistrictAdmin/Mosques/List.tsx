...
const DistrictAdminMosquesList = () => {
  ...
  const { mosquesForDistrict } = filterData
  const {  mosque_heating_fuel, mosque_heating_type, mosque_status, mosque_type } =
    mosquesForDistrict
...
export default DistrictAdminMosquesList
